...
print(
    "{}.val is dependent of {}: {}".format(
        source, destination, is_dependent(source, destination_val, contract)
    )
)
assert not is_dependent(source, destination, contract)
print(
    "{}.val is dependent of {}: {}".format(
        destination, source, is_dependent(destination_val, source_val, contract)
    )
)
...
print(
    "{} is tainted {}".format(
        destination_indirect_1, is_tainted(destination_indirect_1_val, contract)
    )
)
...
print(
    "{} is tainted {}".format(
        destination_indirect_2, is_tainted(destination_indirect_2_val, contract)
    )
)
