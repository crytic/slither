...
slither check-upgradeability --proxy-filename "$DIR_TESTS/proxy.sol" --proxy-name Proxy "$DIR_TESTS/contractV1.sol" ContractV1 > test_1.txt 2>&1
...
slither check-upgradeability --proxy-filename "$DIR_TESTS/proxy.sol" --proxy-name Proxy --new-contract-filename "$DIR_TESTS/contractV2.sol" --new-contract-name ContractV2 "$DIR_TESTS/contractV1.sol" ContractV1 > test_2.txt 2>&1
...
slither check-upgradeability --proxy-filename "$DIR_TESTS/proxy.sol" --proxy-name Proxy --new-contract-filename "$DIR_TESTS/contractV2_bug.sol" --new-contract-name ContractV2 "$DIR_TESTS/contractV1.sol" ContractV1 > test_3.txt 2>&1
...
slither check-upgradeability --proxy-filename "$DIR_TESTS/proxy.sol" --proxy-name Proxy --new-contract-filename "$DIR_TESTS/contractV2_bug2.sol" --new-contract-name ContractV2 "$DIR_TESTS/contractV1.sol" ContractV1 > test_4.txt 2>&1
...
slither check-upgradeability --proxy-filename "$DIR_TESTS/proxy.sol" --proxy-name Proxy "$DIR_TESTS/contract_initialization.sol" Contract_no_bug > test_5.txt 2>&1
...
slither check-upgradeability --proxy-filename "$DIR_TESTS/proxy.sol" --proxy-name Proxy "$DIR_TESTS/contract_initialization.sol" Contract_lack_to_call_modifier > test_6.txt 2>&1
...
slither check-upgradeability --proxy-filename "$DIR_TESTS/proxy.sol" --proxy-name Proxy "$DIR_TESTS/contract_initialization.sol" Contract_not_called_super_init > test_7.txt 2>&1
...
slither check-upgradeability --proxy-filename "$DIR_TESTS/proxy.sol" --proxy-name Proxy "$DIR_TESTS/contract_initialization.sol" Contract_no_bug_inherits > test_8.txt 2>&1
...
slither check-upgradeability --proxy-filename "$DIR_TESTS/proxy.sol" --proxy-name Proxy "$DIR_TESTS/contract_initialization.sol" Contract_double_call > test_9.txt 2>&1
...
slither check-upgradeability --new-contract-filename "$DIR_TESTS/contract_v2_constant.sol" --new-contract-name ContractV2 "$DIR_TESTS/contractV1.sol" ContractV1 > test_10.txt 2>&1
...
slither check-upgradeability --new-contract-filename "$DIR_TESTS/contractV2_struct.sol" --new-contract-name ContractV2 "$DIR_TESTS/contractV1_struct.sol" ContractV1 > test_12.txt 2>&1
...
slither check-upgradeability --new-contract-filename "$DIR_TESTS/contractV2_struct_bug.sol" --new-contract-name ContractV2 "$DIR_TESTS/contractV1_struct.sol" ContractV1 > test_13.txt 2>&1
