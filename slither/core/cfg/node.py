...
class Node(SourceMapping, ChildFunction):
    ...
    def __init__(self, node_type: NodeType, node_id: int):
        ...
        self._phi_origins_member_variables: Dict[str, Tuple[ReferenceVariable, Set["Node"]]] = {}
    ...
    @property
    def phi_origin_member_variables(self) -> Dict[str, Tuple[ReferenceVariable, Set["Node"]]]:
    ...
    def add_phi_origin_member_variable(self, variable: ReferenceVariable, node: "Node"):
