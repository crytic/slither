...
class SourceMapping(Context):
    ...
    def _compute_line(
        ...
        (
            start_line,
            starting_column,
        ) = compilation_unit.core.crytic_compile.get_line_and_character_from_offset(filename, start)
        (
            end_line,
            ending_column,
        ) = compilation_unit.core.crytic_compile.get_line_and_character_from_offset(
