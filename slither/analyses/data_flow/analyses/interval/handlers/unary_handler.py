...
from slither.analyses.data_flow.analyses.interval.managers.constraint_manager import ConstraintManager
...
class UnaryHandler:
    def __init__(self, constraint_storage: ConstraintManager = None):  # pyright: ignore[reportUndefinedVariable]
