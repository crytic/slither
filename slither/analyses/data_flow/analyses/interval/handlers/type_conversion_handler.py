...
class TypeConversionHandler:
    ...
    def handle_type_conversion(self, node: Node, domain: IntervalDomain, operation: TypeConversion):
        ...
        source_variable_range = RangeVariable.get_variable_info(domain, operation.variable)
        ...
        logger.debug(f"Handled type conversion: {result_variable_name} = CONVERT {operation.variable} to {operation.type}")
