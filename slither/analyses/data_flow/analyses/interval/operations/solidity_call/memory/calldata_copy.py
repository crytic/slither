...
class CalldataCopyHandler(BaseOperationHandler):
    ...
    This operation copies calldata to memory but doesn't return a value and doesn't
    affect tracked interval variables directly. We treat it as a no-op for interval
    analysis purposes.
    """
