"""Library call operation handler for interval analysis."""
...
class LibraryCallContext:
    """Context for library call analysis containing result metadata."""
...
class PrefixedStateWrapper:
    """Wrapper that prefixes variable names for namespaced library analysis."""
...
class PrefixedDomainWrapper:
    """Wrapper that provides prefixed state access for library function analysis."""
...
class LibraryCallHandler(BaseOperationHandler):
    ...
    def handle(
        ...
        """Process library call operation with interprocedural analysis."""
        ...
        library_function = operation.function

        if not isinstance(library_function, Function):
        ...
        context = LibraryCallContext(result_name, lvalue_type, call_prefix)
        self._analyze_library_function(library_function, argument_terms, domain, context)

    _call_counter: int = 0

    def _build_call_prefix(self, operation: LibraryCall) -> str:
        """Build unique prefix for library call using incremental counter."""
    ...
    def _analyze_library_function(
        ...
        """Analyze library function with argument constraints."""
    ...
    def _analyze_function_body(
        ...
        """Analyze the library function's body operations."""
        # Import here to avoid circular dependency (registry imports this module)
