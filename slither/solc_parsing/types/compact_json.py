...
def parse_contract_definition(raw: Dict) -> ContractDefinition:
    ...
    return ContractDefinition(raw['contractKind'], raw['linearizedBaseContracts'], base_contracts, nodes_parsed, **_extract_decl_props(raw))
...
def parse_error_definition(raw: Dict) -> ErrorDefinition:
    return ErrorDefinition(parse_parameter_list(raw["parameters"]), **_extract_decl_props(raw))
