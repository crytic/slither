...
class ASTNode:
    __slots__ = "src", "id", "documentation"

    def __init__(self, src: str, id: int, documentation:Optional[str]=None):
        self.src = src
        self.id = id
...
class ErrorDefinition(Declaration):
    ...
    def __init__(self, params: 'ParameterList', **kwargs):
        super().__init__(**kwargs)
        self.params = params
...
class ModifierInvocation(ASTNode):
    ...
    def __init__(self, modifier: Union['Identifier', 'IdentifierPath'], args: Optional[List['Expression']], **kwargs):
        super().__init__(**kwargs)
