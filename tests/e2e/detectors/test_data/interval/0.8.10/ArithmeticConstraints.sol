...
contract ArithmeticConstraintTests {
    ...
    //  */
    // function testMultiplicationConstraint1(
    //     uint8 x
    ...
    //  */
    // function testMultiplicationConstraint2(
    //     uint8 x
    // ) public pure returns (uint8) {
    //     require(x * 3 < 150);
    //     return x;
    ...
    //  */
    // function testMultiplicationConstraint3(
    //     uint8 x
    // ) public pure returns (uint8) {
    //     require(4 * x >= 80);
    //     return x;
    ...
    //  */
    // function testMultiplicationConstraint4(
    //     uint8 x
    // ) public pure returns (uint8) {
    //     require(x * 5 <= 200);
    //     return x;
    ...
    //  */
    // function testNegativeMultiplicationGreater(
    //     int8 x
    ...
    //  */
    // function testNegativeMultiplicationGreaterEqual(
    //     int8 x
    // ) public pure returns (int8) {
    //     require(x * (-2) >= -100);
    //     return x;
    ...
    //  */
    // function testNegativeMultiplicationLessEqual(
    //     int8 x
    // ) public pure returns (int8) {
    //     require(x * (-2) <= -100);
    //     return x;
