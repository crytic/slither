...
STORAGE_TEST_ROOT = os.path.join(SLITHER_ROOT, "tests", "storage_layout")
...
def test_storage_layout():
    ...
    test_item = os.path.join(
            STORAGE_TEST_ROOT, "storage_layout-0.8.10.sol"
        ) 
                ...
                while True:
                    try: 
                        for contract in sl.contracts:
                            ...
                            slot, offset = contract.compilation_unit.storage_layout_of(contract, sl_name)
