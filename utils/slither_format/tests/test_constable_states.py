...
class TestConstableState(unittest.TestCase):
    ...
    def test_unused_state_vars(self):
        ...
        self.assertEqual(outFD_lines.count("Location end: 217"), 1)
        ...
        self.assertEqual(outFD_lines.count("Location end: 266"), 1)
        ...
        self.assertEqual(outFD_lines.count("Location end: 362"), 1)
        ...
        self.assertEqual(outFD_lines.count("Location end: 581"), 1)
        ...
        self.assertEqual(outFD_lines.count("Location end: 844"), 1)
        ...
        self.assertEqual(outFD_lines.count("Location end: 883"), 1)
        outFD.close()
