...
detectors = ['all','abiencoderv2-array','arbitrary-send','array-by-reference',
			...
			'calls-loop','constable-states','constant-function-asm','constant-function-state',
			'controlled-array-length','controlled-delegatecall','costly-loop','dead-code',
			'deprecated-standards','divide-before-multiply','enum-conversion','erc20-indexed',
			'erc20-interface','erc721-interface','events-access','events-maths','external-function',
			'function-init-state','incorrect-equality','incorrect-modifier','incorrect-shift',
			'incorrect-unary','locked-ether','low-level-calls','mapping-deletion',
			'missing-inheritance','missing-zero-check','multiple-constructors','name-reused',
			...
			'shadowing-builtin','shadowing-local','shadowing-state','similar-names',
			'solc-version','storage-array','suicidal','tautology','timestamp','too-many-digits',
			'tx-origin','unchecked-lowlevel','unchecked-send','unchecked-transfer',
